...
var createStyleComponentFile = function (_a) {
    ...
    var nameKebabCase = string_cases_1.kebabCase(nameLowerCase);
...
var createReactComponent = function (_a) {
    ...
    var replacedFile = typeFile.replace(/\{componentName\}/g, string_cases_1.spaceToPascalCase(name));
...
exports.createComponent = function (_a) {
    ...
    var dirPath = config_1.getComponentDirPath() + "/" + string_cases_1.spaceToPascalCase(name);
...
exports.createPage = function (_a) {
    var name = _a.name, type = _a.type, theme = _a.theme;
    var dirPath = config_1.getPageDirPath() + "/" + string_cases_1.spaceToPascalCase(name);
    return createReactComponent({
        name: name,
        type: type,
        theme: theme,
